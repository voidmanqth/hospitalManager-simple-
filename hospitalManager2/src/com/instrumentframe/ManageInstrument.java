 ...
 * @author __USER__
 */
public class ManageInstrument extends javax.swing.JInternalFrame {

	public ManageInstrument(JDesktopPane desktop) {
	...
	private void initComponents() {
		...
		jLabel1.setText("仪器代号");

		jLabel2.setText("仪器名称");

		jLabel3.setText("仪器价格");
		...
		String[] str = m.combo("select replace from instrument");
	...
	private void searchbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		InstrumentModel dm = new InstrumentModel();
		Instrument d = dm.queryOne(r);
		if(d.getName()==null){
			JOptionPane.showMessageDialog(this, "查无此仪器信息");
			return;
		}
	...
	private void uptbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (dm.queryOne(replace.getText()).getName() == null
			...
			instrument.setReplace(replace.getText());
			instrument.setName(name.getText());
			instrument.setPrice(Float.parseFloat(price.getText()));
			instrument.setNum(Integer.parseInt(num.getText()));
			instrument.setRemarks(re);
			boolean flag = false;
			flag = dm.uptinstrument(instrument, search.getSelectedItem().toString());
			if (flag == true) {
			...
			JOptionPane.showMessageDialog(this, "该仪器代号已经存在");
		}
	}
	...
	private void delbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		String r = search.getSelectedItem().toString();
		int yes = JOptionPane.showConfirmDialog(null, "确定删除'" + r + "'号仪器？");
		if (yes == 0) {
			InstrumentModel dm = new InstrumentModel();
...
//增加仪器
	private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (dm.queryOne(replace.getText().toString()).getName() != null) {
			JOptionPane.showMessageDialog(this, "该仪器代号已存在");
			return;
		}
		String re = remarks.getText() == null ? "" : remarks.getText();
		Instrument instrument = new Instrument();
		...
		instrument.setRemarks(re);
		boolean flag = false;
		flag = dm.addinstrument(instrument);
		if (flag == true) {
